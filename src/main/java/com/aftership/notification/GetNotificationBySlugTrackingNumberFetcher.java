...
import com.aftership.model.GetNotificationBySlugTrackingNumberResponse;
import com.aftership.base.Page;
import com.aftership.model.Notification;

import com.aftership.model.GetNotificationBySlugTrackingNumberResponse;

public class GetNotificationBySlugTrackingNumberFetcher extends Fetcher<Notification> {
    private final Map<String, String> headerParams= new HashMap<>(8);

    public GetNotificationBySlugTrackingNumberFetcher addHeaderParam(final String name, final String value) {
    ...
    public GetNotificationBySlugTrackingNumberFetcher setTrackingAccountNumber(String trackingAccountNumber) {
        this.trackingAccountNumber = trackingAccountNumber;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingOriginCountry(String trackingOriginCountry) {
        this.trackingOriginCountry = trackingOriginCountry;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingDestinationCountry(String trackingDestinationCountry) {
        this.trackingDestinationCountry = trackingDestinationCountry;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingKey(String trackingKey) {
        this.trackingKey = trackingKey;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingPostalCode(String trackingPostalCode) {
        this.trackingPostalCode = trackingPostalCode;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingShipDate(String trackingShipDate) {
        this.trackingShipDate = trackingShipDate;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingState(String trackingState) {
        this.trackingState = trackingState;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setSlug(String slug) {
        this.slug = slug;
        return this;
    }

    public GetNotificationBySlugTrackingNumberFetcher setTrackingNumber(String tracking_number) {
    ...
    public Notification fetch(AfterShipClient client) throws Exception {
        ...
        String path = String.format("/tracking/2024-04/notifications/%s/%s", slug,tracking_number);
        Request request = new Request(HttpMethod.GET, path);
        addQueryParams(request);
        setHeaderParams(request);
        Response response = client.request(request);
        AfterShipResponse<GetNotificationBySlugTrackingNumberResponse> trackingResponse = new Gson().fromJson(response.getContent(), new TypeToken<AfterShipResponse<GetNotificationBySlugTrackingNumberResponse>>() {
            }.getType());
