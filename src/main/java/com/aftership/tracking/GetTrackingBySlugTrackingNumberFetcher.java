...
import com.aftership.model.GetTrackingBySlugTrackingNumberResponse;
...
public class GetTrackingBySlugTrackingNumberFetcher extends Fetcher<Tracking> {
    ...
    public Tracking fetch(AfterShipClient client) throws Exception {
        ...
        AfterShipResponse<GetTrackingBySlugTrackingNumberResponse> trackingResponse = new Gson().fromJson(response.getContent(), new TypeToken<AfterShipResponse<GetTrackingBySlugTrackingNumberResponse>>() {
            }.getType());
