...
import com.aftership.tracking.model.DeleteTrackingByIdResponse;
import com.aftership.tracking.model.Tracking;

public class DeleteTrackingByIdDeleter extends Deleter<DeleteTrackingByIdResponse> {
    ...
    @Override
    public DeleteTrackingByIdResponse delete(AfterShipClient client) throws Exception {
