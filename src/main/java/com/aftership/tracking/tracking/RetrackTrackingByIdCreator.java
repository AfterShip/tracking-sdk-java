...
import com.aftership.tracking.model.RetrackTrackingByIdResponse;
...
public class RetrackTrackingByIdCreator extends Creator<RetrackTrackingByIdResponse> {
  ...
  @Override
  public RetrackTrackingByIdResponse create(AfterShipClient client) throws Exception {
    if (id == null || id.isEmpty()) {
      throw new ApiException(ErrorEnum.BAD_REQUEST.name(), "Invalid request: `id` is invalid");
    }
    String path = String.format("/tracking/2026-07/trackings/%s/retrack", id);
