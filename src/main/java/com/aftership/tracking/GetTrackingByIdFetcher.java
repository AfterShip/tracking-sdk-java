...
import com.aftership.model.GetTrackingByIdResponse;
...
public class GetTrackingByIdFetcher extends Fetcher<Tracking> {
    ...
    public Tracking fetch(AfterShipClient client) throws Exception {
        ...
        AfterShipResponse<GetTrackingByIdResponse> trackingResponse = new Gson().fromJson(response.getContent(), new TypeToken<AfterShipResponse<GetTrackingByIdResponse>>() {
            }.getType());
