...
import com.aftership.model.DeleteTrackingByIdResponse;
import com.aftership.base.Page;
import com.aftership.model.PartialDeleteTracking;

import com.aftership.model.DeleteTrackingByIdResponse;

public class DeleteTrackingByIdDeleter extends Deleter<PartialDeleteTracking> {
    ...
    public PartialDeleteTracking delete(AfterShipClient client) throws Exception {
        ...
        AfterShipResponse<DeleteTrackingByIdResponse> trackingResponse = new Gson().fromJson(response.getContent(), new TypeToken<AfterShipResponse<DeleteTrackingByIdResponse>>() {
            }.getType());
