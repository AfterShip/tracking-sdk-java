...
public class GetTrackingsReader extends Reader<Tracking> {
  ...
  public GetTrackingsReader setCourierDestinationCountryRegion(
  ...
  public Page<Tracking> read(AfterShipClient client) throws Exception {
    ...
    AfterShipResponse<GetTrackingsResponse> trackingResponse =
        new Gson()
            .fromJson(
                response.getContent(),
                new TypeToken<AfterShipResponse<GetTrackingsResponse>>() {}.getType());
