...
public class UpdateTrackingByIdRequest extends Resource {
  ...
  private java.util.List<UpdateTrackingByIdRequestCustomers> customers;

  @SerializedName("shipment_direction")
  private UpdateTrackingByIdRequestShipmentDirection shipmentDirection;
  ...
  public void setOrderPromisedDeliveryDate(
      UpdateTrackingByIdRequestOrderPromisedDeliveryDate orderPromisedDeliveryDate) {
    this.orderPromisedDeliveryDate = orderPromisedDeliveryDate;
  }

  public UpdateTrackingByIdRequestDeliveryType getDeliveryType() {
    return deliveryType;
  }

  public void setDeliveryType(UpdateTrackingByIdRequestDeliveryType deliveryType) {
  ...
  public java.util.List<UpdateTrackingByIdRequestCustomers> getCustomers() {
    return customers;
  }

  public void setCustomers(java.util.List<UpdateTrackingByIdRequestCustomers> customers) {
    this.customers = customers;
  }

  public UpdateTrackingByIdRequestShipmentDirection getShipmentDirection() {
    return shipmentDirection;
  }

  public void setShipmentDirection(UpdateTrackingByIdRequestShipmentDirection shipmentDirection) {
