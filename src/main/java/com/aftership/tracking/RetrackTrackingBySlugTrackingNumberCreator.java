...
import com.aftership.model.RetrackTrackingBySlugTrackingNumberResponse;
import com.aftership.base.Page;
import com.aftership.model.PartialUpdateTracking;

import com.aftership.model.RetrackTrackingBySlugTrackingNumberResponse;

public class RetrackTrackingBySlugTrackingNumberCreator extends Creator<PartialUpdateTracking> {
    ...
    public PartialUpdateTracking create(AfterShipClient client) throws Exception {
        ...
        String path = String.format("/tracking/2024-04/trackings/%s/%s/retrack", slug,tracking_number);
        Request request = new Request(HttpMethod.POST, path);
        addQueryParams(request);
        setHeaderParams(request);
        Response response = client.request(request);
        AfterShipResponse<RetrackTrackingBySlugTrackingNumberResponse> trackingResponse = new Gson().fromJson(response.getContent(), new TypeToken<AfterShipResponse<RetrackTrackingBySlugTrackingNumberResponse>>() {
            }.getType());
