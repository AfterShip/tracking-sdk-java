...
public class HttpClient {
  ...
  private static final String DEFAULT_USER_AGENT =
      "aftership-sdk-java/10.0.0 (https://www.aftership.com) apache-httpclient/4.5.14";
  ...
  public HttpClient(final RequestConfig requestConfig, String userAgent, String domain) {
    ...
    client =
        clientBuilder.setDefaultHeaders(headers).setDefaultRequestConfig(requestConfig).build();
  }
