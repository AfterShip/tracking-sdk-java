...
public class RetrackTrackingBySlugTrackingNumberResponse extends Resource {
    ...
    private ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse shipmentWeight;
    ...
    private AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate;

    @SerializedName("custom_estimated_delivery_date")
    private CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate;

    @SerializedName("order_number")
    private String orderNumber;

    @SerializedName("first_estimated_delivery")
    private FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse firstEstimatedDelivery;

    @SerializedName("latest_estimated_delivery")
    private LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse latestEstimatedDelivery;
    ...
    private java.util.List<NextCouriersRetrackTrackingBySlugTrackingNumberResponse> nextCouriers;
    ...
    private CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse carbonEmissions;
    ...
    public ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse getShipmentWeight() {
        return shipmentWeight;
    }

    public void setShipmentWeight(ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse shipmentWeight) {
    ...
    public AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse getAftershipEstimatedDeliveryDate() {
        return aftershipEstimatedDeliveryDate;
    }

    public void setAftershipEstimatedDeliveryDate(AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate) {
        this.aftershipEstimatedDeliveryDate = aftershipEstimatedDeliveryDate;
    }

    public CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse getCustomEstimatedDeliveryDate() {
        return customEstimatedDeliveryDate;
    }

    public void setCustomEstimatedDeliveryDate(CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate) {
    ...
    public FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse getFirstEstimatedDelivery() {
        return firstEstimatedDelivery;
    }

    public void setFirstEstimatedDelivery(FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse firstEstimatedDelivery) {
        this.firstEstimatedDelivery = firstEstimatedDelivery;
    }

    public LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse getLatestEstimatedDelivery() {
        return latestEstimatedDelivery;
    }

    public void setLatestEstimatedDelivery(LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse latestEstimatedDelivery) {
    ...
    public java.util.List<NextCouriersRetrackTrackingBySlugTrackingNumberResponse> getNextCouriers() {
        return nextCouriers;
    }

    public void setNextCouriers(java.util.List<NextCouriersRetrackTrackingBySlugTrackingNumberResponse> nextCouriers) {
    ...
    public CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse getCarbonEmissions() {
        return carbonEmissions;
    }

    public void setCarbonEmissions(CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse carbonEmissions) {
