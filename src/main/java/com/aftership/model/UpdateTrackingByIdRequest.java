...
public class UpdateTrackingByIdRequest extends Resource {
  ...
  private java.util.List<CustomersUpdateTrackingByIdRequest> customers;
  ...
  public java.util.List<CustomersUpdateTrackingByIdRequest> getCustomers() {
    return customers;
  }

  public void setCustomers(java.util.List<CustomersUpdateTrackingByIdRequest> customers) {
