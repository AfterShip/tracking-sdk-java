...
public class RetrackTrackingByIdResponse extends Resource {
  ...
  private CourierEstimatedDeliveryDateRetrackTrackingByIdResponse courierEstimatedDeliveryDate;
  ...
  private FirstMileRetrackTrackingByIdResponse firstMile;

  @SerializedName("last_mile")
  private LastMileRetrackTrackingByIdResponse lastMile;

  @SerializedName("customers")
  private java.util.List<CustomersRetrackTrackingByIdResponse> customers;
  ...
  public CourierEstimatedDeliveryDateRetrackTrackingByIdResponse getCourierEstimatedDeliveryDate() {
    return courierEstimatedDeliveryDate;
  }

  public void setCourierEstimatedDeliveryDate(
      CourierEstimatedDeliveryDateRetrackTrackingByIdResponse courierEstimatedDeliveryDate) {
  ...
  public void setShipmentWeight(ShipmentWeightRetrackTrackingByIdResponse shipmentWeight) {
  ...
  public void setAftershipEstimatedDeliveryDate(
      AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse aftershipEstimatedDeliveryDate) {
  ...
  public void setCustomEstimatedDeliveryDate(
      CustomEstimatedDeliveryDateRetrackTrackingByIdResponse customEstimatedDeliveryDate) {
  ...
  public void setFirstEstimatedDelivery(
      FirstEstimatedDeliveryRetrackTrackingByIdResponse firstEstimatedDelivery) {
  ...
  public void setLatestEstimatedDelivery(
      LatestEstimatedDeliveryRetrackTrackingByIdResponse latestEstimatedDelivery) {
  ...
  public void setCarbonEmissions(CarbonEmissionsRetrackTrackingByIdResponse carbonEmissions) {
  ...
  public FirstMileRetrackTrackingByIdResponse getFirstMile() {
    return firstMile;
  }

  public void setFirstMile(FirstMileRetrackTrackingByIdResponse firstMile) {
    this.firstMile = firstMile;
  }

  public LastMileRetrackTrackingByIdResponse getLastMile() {
    return lastMile;
  }

  public void setLastMile(LastMileRetrackTrackingByIdResponse lastMile) {
    this.lastMile = lastMile;
  }

  public java.util.List<CustomersRetrackTrackingByIdResponse> getCustomers() {
    return customers;
  }

  public void setCustomers(java.util.List<CustomersRetrackTrackingByIdResponse> customers) {
