...
public class MarkTrackingCompletedBySlugTrackingNumberResponse extends Resource {
    ...
    private ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse shipmentWeight;
    ...
    private AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate;

    @SerializedName("custom_estimated_delivery_date")
    private CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse customEstimatedDeliveryDate;

    @SerializedName("order_number")
    private String orderNumber;

    @SerializedName("first_estimated_delivery")
    private FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse firstEstimatedDelivery;

    @SerializedName("latest_estimated_delivery")
    private LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse latestEstimatedDelivery;
    ...
    private java.util.List<NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse> nextCouriers;
    ...
    private CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse carbonEmissions;
    ...
    public ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse getShipmentWeight() {
        return shipmentWeight;
    }

    public void setShipmentWeight(ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse shipmentWeight) {
    ...
    public AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse getAftershipEstimatedDeliveryDate() {
        return aftershipEstimatedDeliveryDate;
    }

    public void setAftershipEstimatedDeliveryDate(AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate) {
        this.aftershipEstimatedDeliveryDate = aftershipEstimatedDeliveryDate;
    }

    public CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse getCustomEstimatedDeliveryDate() {
        return customEstimatedDeliveryDate;
    }

    public void setCustomEstimatedDeliveryDate(CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse customEstimatedDeliveryDate) {
    ...
    public FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse getFirstEstimatedDelivery() {
        return firstEstimatedDelivery;
    }

    public void setFirstEstimatedDelivery(FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse firstEstimatedDelivery) {
        this.firstEstimatedDelivery = firstEstimatedDelivery;
    }

    public LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse getLatestEstimatedDelivery() {
        return latestEstimatedDelivery;
    }

    public void setLatestEstimatedDelivery(LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse latestEstimatedDelivery) {
    ...
    public java.util.List<NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse> getNextCouriers() {
        return nextCouriers;
    }

    public void setNextCouriers(java.util.List<NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse> nextCouriers) {
    ...
    public CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse getCarbonEmissions() {
        return carbonEmissions;
    }

    public void setCarbonEmissions(CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse carbonEmissions) {
