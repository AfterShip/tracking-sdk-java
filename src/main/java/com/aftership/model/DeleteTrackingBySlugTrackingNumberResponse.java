...
public class DeleteTrackingBySlugTrackingNumberResponse extends Resource {
    ...
    private ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse shipmentWeight;
    ...
    private AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate;

    @SerializedName("custom_estimated_delivery_date")
    private CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate;

    @SerializedName("order_number")
    private String orderNumber;

    @SerializedName("first_estimated_delivery")
    private FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse firstEstimatedDelivery;

    @SerializedName("latest_estimated_delivery")
    private LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse latestEstimatedDelivery;
    ...
    private java.util.List<NextCouriersDeleteTrackingBySlugTrackingNumberResponse> nextCouriers;
    ...
    private CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse carbonEmissions;
    ...
    public ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse getShipmentWeight() {
        return shipmentWeight;
    }

    public void setShipmentWeight(ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse shipmentWeight) {
    ...
    public AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse getAftershipEstimatedDeliveryDate() {
        return aftershipEstimatedDeliveryDate;
    }

    public void setAftershipEstimatedDeliveryDate(AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate) {
        this.aftershipEstimatedDeliveryDate = aftershipEstimatedDeliveryDate;
    }

    public CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse getCustomEstimatedDeliveryDate() {
        return customEstimatedDeliveryDate;
    }

    public void setCustomEstimatedDeliveryDate(CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate) {
    ...
    public FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse getFirstEstimatedDelivery() {
        return firstEstimatedDelivery;
    }

    public void setFirstEstimatedDelivery(FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse firstEstimatedDelivery) {
        this.firstEstimatedDelivery = firstEstimatedDelivery;
    }

    public LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse getLatestEstimatedDelivery() {
        return latestEstimatedDelivery;
    }

    public void setLatestEstimatedDelivery(LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse latestEstimatedDelivery) {
    ...
    public java.util.List<NextCouriersDeleteTrackingBySlugTrackingNumberResponse> getNextCouriers() {
        return nextCouriers;
    }

    public void setNextCouriers(java.util.List<NextCouriersDeleteTrackingBySlugTrackingNumberResponse> nextCouriers) {
    ...
    public CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse getCarbonEmissions() {
        return carbonEmissions;
    }

    public void setCarbonEmissions(CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse carbonEmissions) {
