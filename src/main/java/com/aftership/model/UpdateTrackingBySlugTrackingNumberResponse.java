...
public class UpdateTrackingBySlugTrackingNumberResponse extends Resource {
    ...
    private ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse shipmentWeight;
    ...
    private AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate;

    @SerializedName("custom_estimated_delivery_date")
    private CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate;

    @SerializedName("order_number")
    private String orderNumber;

    @SerializedName("first_estimated_delivery")
    private FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse firstEstimatedDelivery;

    @SerializedName("latest_estimated_delivery")
    private LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse latestEstimatedDelivery;
    ...
    private java.util.List<NextCouriersUpdateTrackingBySlugTrackingNumberResponse> nextCouriers;
    ...
    private CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse carbonEmissions;
    ...
    public ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse getShipmentWeight() {
        return shipmentWeight;
    }

    public void setShipmentWeight(ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse shipmentWeight) {
    ...
    public AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse getAftershipEstimatedDeliveryDate() {
        return aftershipEstimatedDeliveryDate;
    }

    public void setAftershipEstimatedDeliveryDate(AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate) {
        this.aftershipEstimatedDeliveryDate = aftershipEstimatedDeliveryDate;
    }

    public CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse getCustomEstimatedDeliveryDate() {
        return customEstimatedDeliveryDate;
    }

    public void setCustomEstimatedDeliveryDate(CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate) {
    ...
    public FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse getFirstEstimatedDelivery() {
        return firstEstimatedDelivery;
    }

    public void setFirstEstimatedDelivery(FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse firstEstimatedDelivery) {
        this.firstEstimatedDelivery = firstEstimatedDelivery;
    }

    public LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse getLatestEstimatedDelivery() {
        return latestEstimatedDelivery;
    }

    public void setLatestEstimatedDelivery(LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse latestEstimatedDelivery) {
    ...
    public java.util.List<NextCouriersUpdateTrackingBySlugTrackingNumberResponse> getNextCouriers() {
        return nextCouriers;
    }

    public void setNextCouriers(java.util.List<NextCouriersUpdateTrackingBySlugTrackingNumberResponse> nextCouriers) {
    ...
    public CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse getCarbonEmissions() {
        return carbonEmissions;
    }

    public void setCarbonEmissions(CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse carbonEmissions) {
