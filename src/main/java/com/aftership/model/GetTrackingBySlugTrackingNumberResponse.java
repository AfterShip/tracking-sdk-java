...
public class GetTrackingBySlugTrackingNumberResponse extends Resource {
    ...
    private ShipmentWeightGetTrackingBySlugTrackingNumberResponse shipmentWeight;
    ...
    private AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate;

    @SerializedName("custom_estimated_delivery_date")
    private CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate;

    @SerializedName("order_number")
    private String orderNumber;

    @SerializedName("first_estimated_delivery")
    private FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse firstEstimatedDelivery;

    @SerializedName("latest_estimated_delivery")
    private LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse latestEstimatedDelivery;
    ...
    private java.util.List<NextCouriersGetTrackingBySlugTrackingNumberResponse> nextCouriers;
    ...
    private CarbonEmissionsGetTrackingBySlugTrackingNumberResponse carbonEmissions;
    ...
    public ShipmentWeightGetTrackingBySlugTrackingNumberResponse getShipmentWeight() {
        return shipmentWeight;
    }

    public void setShipmentWeight(ShipmentWeightGetTrackingBySlugTrackingNumberResponse shipmentWeight) {
    ...
    public AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse getAftershipEstimatedDeliveryDate() {
        return aftershipEstimatedDeliveryDate;
    }

    public void setAftershipEstimatedDeliveryDate(AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse aftershipEstimatedDeliveryDate) {
        this.aftershipEstimatedDeliveryDate = aftershipEstimatedDeliveryDate;
    }

    public CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse getCustomEstimatedDeliveryDate() {
        return customEstimatedDeliveryDate;
    }

    public void setCustomEstimatedDeliveryDate(CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse customEstimatedDeliveryDate) {
    ...
    public FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse getFirstEstimatedDelivery() {
        return firstEstimatedDelivery;
    }

    public void setFirstEstimatedDelivery(FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse firstEstimatedDelivery) {
        this.firstEstimatedDelivery = firstEstimatedDelivery;
    }

    public LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse getLatestEstimatedDelivery() {
        return latestEstimatedDelivery;
    }

    public void setLatestEstimatedDelivery(LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse latestEstimatedDelivery) {
    ...
    public java.util.List<NextCouriersGetTrackingBySlugTrackingNumberResponse> getNextCouriers() {
        return nextCouriers;
    }

    public void setNextCouriers(java.util.List<NextCouriersGetTrackingBySlugTrackingNumberResponse> nextCouriers) {
    ...
    public CarbonEmissionsGetTrackingBySlugTrackingNumberResponse getCarbonEmissions() {
        return carbonEmissions;
    }

    public void setCarbonEmissions(CarbonEmissionsGetTrackingBySlugTrackingNumberResponse carbonEmissions) {
